...
import "../../../static/admin/assets/plugin/chartist-js/dist/chartist.min.css";
import "../../../static/admin/assets/plugin/chartist-js/dist/chartist-init.css";
import "../../../static/admin/assets/plugin/chartist-plugin-tooltip-master/dist/chartist-plugin-tooltip.css"
import "../../../static/admin/assets/plugin/css-chart/css-chart.css";
// import "../../../static/admin/assets/plugin/toast-master/css/jquery.toast.css";
import "../../../static/admin/css/style.css";
import "../../../static/admin/css/colors/blue.css";
import logo from "../../../static/admin/assets/images/logo-icon.png";
import logoicon from "../../../static/admin/assets/images/logo-light-icon.png";
import logotext from "../../../static/admin/assets/images/logo-text.png";
import logo1 from "../../../static/admin/assets/images/logo-light-text.png";
import user1 from "../../../static/admin/assets/images/users/1.jpg";
import user2 from "../../../static/admin/assets/images/users/2.jpg";
import user3 from "../../../static/admin/assets/images/users/3.jpg";
import user4 from "../../../static/admin/assets/images/users/4.jpg";
import img1 from "../../../static/admin/assets/images/big/img1.jpg";
import img2 from "../../../static/admin/assets/images/big/img2.jpg";
import img3 from "../../../static/admin/assets/images/big/img3.jpg";
...
let Index = () => {
    ...
    return (
        <body classNameName="fix-header fix-sidebar card-no-border">
            <div id="main-wrapper">
                <header className="topbar">
                    <nav className="navbar top-navbar navbar-expand-md navbar-light">
                        <div className="navbar-header">
                            <a className="navbar-brand" href="index.html">
                                <b><i className="wi wi-sunset"></i>
                                ...
                                <span>
                                    ...
                                    <img src={logo1} className="light-logo" alt="homepage" /></span> </a>
                        </div>
                        <div className="navbar-collapse">
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                <div className="message-center">
                                                    ...
                                                    <a href="#">
                                                        <div className="user-img"> <img src={user3} alt="user" className="img-circle" /> <span className="profile-status away pull-right"></span> </div>
                                                        <div className="mail-contnet">
                                                ...
                                                <div id="carouselExampleControls" className="carousel slide" data-ride="carousel">
                                                    <div className="carousel-inner" role="listbox">
                                                        <div className="carousel-item active">
                                                            <div className="container"> <img className="d-block img-fluid" src={img1} alt="First slide" /></div>
                                                        </div>
                                                        <div className="carousel-item">
                                                            <div className="container"><img className="d-block img-fluid" src={img2} alt="Second slide" /></div>
                                                        </div>
                                                        <div className="carousel-item">
                                                            <div className="container"><img className="d-block img-fluid" src={img3} alt="Third slide" /></div>
                                                        </div>
                                                    </div>
                            ...
                            <ul className="navbar-nav my-lg-0">
                                ...
                                <li className="nav-item dropdown">
                                    <a className="nav-link dropdown-toggle text-muted waves-effect waves-dark" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src={user1} alt="user" className="profile-pic" /></a>
                                    <div className="dropdown-menu dropdown-menu-right animated flipInY">
                                        <ul className="dropdown-user">
                                            <li>
                                                <div className="dw-user-box">
                                                    <div className="u-img"><img src={user1} alt="user" /></div>
                ...
                <aside className="left-sidebar">
                    <div className="scroll-sidebar">
                        <div className="user-profile">
                            <div className="profile-img"> <img src={user1} alt="user" /> </div>
                            ...
                            <nav className="sidebar-nav">
                                <ul id="sidebarnav">
                                    ...
                                    <li>
                                        <Link to="/" aria-expanded="false"><i className="mdi mdi-gauge"></i><span className="hide-menu">Dashboard </span></Link>
                                    </li>
                                    <li>
                                        <Link to="/demo" aria-expanded="false"><i className="mdi mdi-bullseye"></i><span className="hide-menu">Demo</span></Link>
                                    </li>
                                </ul>
                            </nav>
                    </div>
            ...
            <script src="../../../static/admin/static/plugin/jquery/jquery.min.js"></script>
            <script src="../../../static/admin/static/plugin/bootstrap/js/popper.min.js"></script>
            <script src="../../../static/admin/static/plugin/bootstrap/js/bootstrap.min.js"></script>
            <script src="../../../static/admin/jquery.slimscroll.js"></script>
            <script src="../../../static/admin/waves.js"></script>
            <script src="../../../static/admin/sidebarmenu.js"></script>
            <script src="../../../static/admin/static/plugin/sticky-kit-master/dist/sticky-kit.min.js"></script>
            <script src="../../../static/admin/custom.min.js"></script>
            <script src="../../../static/admin/static/plugin/chartist-js/dist/chartist.min.js"></script>
            <script
                src="../../../static/admin/static/plugin/chartist-plugin-tooltip-master/dist/chartist-plugin-tooltip.min.js"></script>
            <script src="../../../static/admin/static/plugin/echarts/echarts-all.js"></script>
            <script src="../../../static/admin/static/plugin/toast-master/js/jquery.toast.js"></script>
            <script src="../../../static/admin/dashboard1.js"></script>
            <script src="../../../static/admin/toastr.js"></script>
            <script src="../../../static/admin/static/plugin/styleswitcher/jQuery.style.switcher.js"></script>
        </body>
    )
}
